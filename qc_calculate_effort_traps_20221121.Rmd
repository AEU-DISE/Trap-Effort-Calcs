...
sample <- read.csv("data_raw/Sample_20221121.csv")
effort <- read.csv("data_raw/TrapEffort_20221121.csv")
...
```{r}
write.csv(sampeffort.hours, file = "data_clean/YBFMP_TrapHours_2010_2022.csv", row.names = FALSE)
```
